...
namespace SmartWeChat.Core
{
    ...
    public class MessageHandler
    {
        ...
        public MessageHandler(SmartWeChatOptions options, Func<MessageBase, ReplyMessageModelBase> handler)
        {
            _customHandle = handler;
        }

        public MessageHandler(ISmartWeChatMessageHandler _handler, SmartWeChatOptions sOptions)
        {
            _options = sOptions;
